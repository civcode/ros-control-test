...
class ROBOTHardwareInterface : public hardware_interface::RobotHW 
{
	public:
        ...
        ros::Publisher motor_effort_pub;
        ros::Subscriber encoder_speed_sub;
        ros::Subscriber encoder_position_sub;
        ros::Subscriber velocity_controller_command_sub;
    ...
    protected:
        ...
        float encoder_speed_;
        float encoder_position_;
        float motor_effort_;
        float velocity_command_;
        void encoderSpeedCb(const std_msgs::Float32 &msg);
        void encoderPositionCb(const std_msgs::Float32 &msg);
        void velocityControllerCb(const std_msgs::Float64 &msg);
};
